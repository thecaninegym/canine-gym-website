    ...
    <nav style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: 'white', borderBottom: '1px solid #eee', padding: '0 24px' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '68px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '28px' }} className="desktop-nav">
          ...
          <a href="https://app.thecaninegym.com/?mode=login" className="login-link" style={{ color: '#003087', textDecoration: 'none', fontSize: '15px', fontWeight: '600' }}>Log In</a>
          <a href="https://app.thecaninegym.com/?mode=signup" className="btn-primary-nav" style={{ backgroundColor: '#FF6B35', color: 'white', padding: '10px 22px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '15px' }}>Get Started</a>
        </div>
      ...
      {menuOpen && (
        <div style={{ borderTop: '1px solid #eee', padding: '16px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <a href="https://app.thecaninegym.com/?mode=login" style={{ color: '#003087', textDecoration: 'none', fontWeight: '600', fontSize: '16px' }}>Log In</a>
          <a href="https://app.thecaninegym.com/?mode=signup" style={{ backgroundColor: '#FF6B35', color: 'white', padding: '12px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '16px', textAlign: 'center' }}>Get Started</a>
        </div>
      )}
    </nav>
  )
