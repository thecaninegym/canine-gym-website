        ...
        <div className="founder-grid">
          <div className="founder-photo">
            <div style={{ position: 'relative' }}>
              <img src="/mia.jpeg" alt="Mia, founder of The Canine Gym, with her two pugs" style={{ borderRadius: '24px', width: '100%', height: '480px', objectFit: 'cover', objectPosition: 'center 20%', display: 'block' }} />
