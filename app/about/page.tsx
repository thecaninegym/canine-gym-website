...
export default function About() {
  return (
    <div style={{ fontFamily: "'Segoe UI', sans-serif", color: '#111', backgroundColor: 'white' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #003087 0%, #004db3 100%)', padding: '100px 24px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '700px', margin: '0 auto' }}>
          ...
          <h1 style={{ color: 'white', fontSize: 'clamp(36px, 5vw, 58px)', fontWeight: '800', margin: '0 0 24px 0', letterSpacing: '-1px', lineHeight: 1.1 }}>
            Born From a Love<br /><span style={{ color: '#FF6B35' }}>of Dogs.</span>
          </h1>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              {[
                ...
                <div key={i} style={{ backgroundColor: '#f8f9fa', borderRadius: '12px', padding: '16px 20px', textAlign: 'center', border: '1px solid #eee', minWidth: '100px' }}>
                  <p style={{ fontSize: '20px', fontWeight: '900', color: '#003087', margin: '0 0 4px 0' }}>{stat.value}</p>
      ...
      {/* WHY WE EXIST */}
      <section style={{ padding: '100px 24px', background: 'linear-gradient(135deg, #001a4d 0%, #003087 100%)' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '64px' }}>
            <p style={{ color: '#FF6B35', fontWeight: '700', fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', margin: '0 0 12px 0' }}>Why We Exist</p>
      ...
      <section style={{ padding: '100px 24px', backgroundColor: 'white' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '64px' }}>
            <p style={{ color: '#FF6B35', fontWeight: '700', fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', margin: '0 0 12px 0' }}>The Journey</p>
            <h2 style={{ fontSize: 'clamp(28px, 3vw, 42px)', fontWeight: '800', color: '#003087', margin: 0, letterSpacing: '-0.5px' }}>How We Got Here</h2>
          </div>
          {[
            ...
            <div key={i} style={{ display: 'flex', gap: '28px', marginBottom: i < arr.length - 1 ? '0' : '0' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0 }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: i % 2 === 0 ? '#f0f4ff' : '#fff5f0', border: `2px solid ${i % 2 === 0 ? '#003087' : '#FF6B35'}30`, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ fontSize: '11px', fontWeight: '800', color: i % 2 === 0 ? '#003087' : '#FF6B35' }}>{item.year}</span>
                </div>
      ...
      {/* CTA */}
      <section style={{ padding: '100px 24px', background: 'linear-gradient(135deg, #003087 0%, #004db3 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <a href="https://app.thecaninegym.com" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', backgroundColor: '#FF6B35', color: 'white', padding: '18px 40px', borderRadius: '10px', textDecoration: 'none', fontWeight: 'bold', fontSize: '17px' }}>
