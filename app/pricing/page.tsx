    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif", color: '#111', backgroundColor: 'white' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #003087 0%, #004db3 100%)', padding: '80px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <p style={{ color: '#FF6B35', fontWeight: '700', fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', margin: '0 0 16px 0' }}>Simple Pricing</p>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div className="plans-grid">
            {[
              ...
              { name: 'Athlete', sessions: 12, price: '$480', perSession: '$40', color: '#003087', popular: false, desc: 'Maximum results for serious fitness goals.' },
            ].map((plan) => (
              <div key={plan.name} style={{ backgroundColor: 'white', borderRadius: '16px', padding: '36px 28px', border: plan.popular ? '2px solid #FF6B35' : '1px solid #eee', position: 'relative', boxShadow: plan.popular ? '0 8px 30px rgba(255,107,53,0.15)' : '0 2px 8px rgba(0,0,0,0.06)' }}>
                {plan.popular && (
                ...
                <a href="https://app.thecaninegym.com" style={{ display: 'block', marginTop: '28px', backgroundColor: plan.popular ? '#FF6B35' : '#003087', color: 'white', padding: '14px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '15px', textAlign: 'center' }}>
                  Get Started
                </a>
              </div>
            ))}
          ...
          <div className="alacarte" style={{ backgroundColor: 'white', borderRadius: '12px', padding: '28px 32px', border: '1px solid #eee', marginTop: '24px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
              ...
              <a href="https://app.thecaninegym.com" style={{ backgroundColor: '#f0f2f5', color: '#003087', padding: '13px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '15px' }}>Book Now</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '60px 24px', backgroundColor: '#f8f9fa', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '26px', fontWeight: '800', color: '#003087', margin: '0 0 12px 0' }}>Have Questions?</h2>
          ...
          <a href="/faq" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#003087', color: 'white', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '15px' }}>View FAQ</a>
        </div>
      </section>
