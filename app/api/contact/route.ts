...
export async function POST(req: Request) {
  try {
    ...
    await resend.emails.send({
      ...
      html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto"><h2 style="color:#003087">New Contact Form Submission</h2><table style="width:100%;border-collapse:collapse"><tr style="border-bottom:1px solid #eee"><td style="padding:12px 0;font-weight:bold;color:#555;width:120px">Name</td><td style="padding:12px 0;color:#111">${name}</td></tr><tr style="border-bottom:1px solid #eee"><td style="padding:12px 0;font-weight:bold;color:#555">Email</td><td style="padding:12px 0;color:#111">${email}</td></tr><tr style="border-bottom:1px solid #eee"><td style="padding:12px 0;font-weight:bold;color:#555">City</td><td style="padding:12px 0;color:#111">${city}</td></tr><tr><td style="padding:12px 0;font-weight:bold;color:#555;vertical-align:top">Message</td><td style="padding:12px 0;color:#111;line-height:1.6">${message.replace(/\n/g, '<br/>')}</td></tr></table></div>`,
    })
