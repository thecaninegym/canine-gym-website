...
export async function POST(req: Request) {
  try {
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #003087, #004db3); padding: 40px 32px; border-radius: 12px 12px 0 0; text-align: center;">
          ...
          <div style="padding: 32px; border: 1px solid #eee; border-top: none; border-radius: 0 0 12px 12px;">
            ...
            <p style="color: #555; font-size: 15px; line-height: 1.7; margin: 0 0 28px 0;">Here's a copy of what you sent:</p>
            <div style="background: #f8f9fa; border-radius: 10px; padding: 20px 24px; margin-bottom: 28px;">
              <p style="color: #999; font-size: 12px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin: 0 0 8px 0;">Your Message</p>
              <p style="color: #333; font-size: 15px; line-height: 1.7; margin: 0;">${message.replace(/\n/g, '<br/>')}</p>
            </div>
            <p style="color: #555; font-size: 15px; line-height: 1.7; margin: 0 0 28px 0;">
              In the meantime, feel free to explore our app and book a session for your pup!
            </p>
            <a href="https://app.thecaninegym.com" style="display: inline-block; background: #FF6B35; color: white; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 15px;">
              Visit The Canine Gym App
            </a>
            <hr style="border: none; border-top: 1px solid #eee; margin: 32px 0;" />
            <p style="color: #aaa; font-size: 13px; margin: 0;">The Canine Gym · Hamilton County, Indiana · <a href="https://thecaninegym.com" style="color: #aaa;">thecaninegym.com</a></p>
          </div>
        </div>
      `,
    })
