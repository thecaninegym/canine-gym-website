    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif", color: '#111', backgroundColor: 'white' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, #003087 0%, #004db3 100%)', padding: '80px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <p style={{ color: '#FF6B35', fontWeight: '700', fontSize: '13px', letterSpacing: '2px', textTransform: 'uppercase', margin: '0 0 16px 0' }}>FAQ</p>
        ...
        <div style={{ maxWidth: '780px', margin: '0 auto' }}>
          {categories.map((cat, ci) => (
            <div key={ci} style={{ marginBottom: '56px' }}>
              <h2 style={{ fontSize: '20px', fontWeight: '800', color: '#003087', margin: '0 0 20px 0', paddingBottom: '12px', borderBottom: '2px solid #e9ecef' }}>{cat.label}</h2>
      ...
      <section style={{ padding: '60px 24px', backgroundColor: 'white', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '26px', fontWeight: '800', color: '#003087', margin: '0 0 12px 0' }}>Still Have Questions?</h2>
          ...
          <a href="/contact" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#FF6B35', color: 'white', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold', fontSize: '15px' }}>Contact Us</a>
        </div>
      </section>
